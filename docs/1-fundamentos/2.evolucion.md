---
id: evolucion
title: "📚 Evolución histórica de la IA"
sidebar_label: "📚 Evolución histórica"
sidebar_position: 2
...
* Reconocer los principales hitos científicos y tecnológicos que han impulsado el desarrollo de la IA.
* Diferenciar las distintas generaciones de tecnologías de IA.
* Analizar cómo los avances en capacidad computacional y disponibilidad de datos han influido en el desarrollo de la IA.
* Relacionar la evolución de la IA con su incorporación progresiva en el sector público.

---

## Introducción

La Inteligencia Artificial (IA) es una disciplina científica y tecnológica que ha experimentado una transformación radical desde sus inicios a mediados del siglo XX hasta convertirse en un motor económico fundamental en la actualidad. Comprender su historia permite a los funcionarios públicos dimensionar no solo la rapidez de su avance, sino también la madurez de los conceptos que hoy se aplican en la gestión estatal.

Suele percibirse como una tecnología reciente, especialmente tras la irrupción de herramientas como ChatGPT, Microsoft Copilot o Gemini. Sin embargo, sus fundamentos científicos comenzaron a desarrollarse hace más de setenta años. Su evolución ha estado marcada por períodos de grandes expectativas, seguidos de etapas de estancamiento, conocidas como los "inviernos de la IA", hasta llegar a la explosión de capacidades observada en la actualidad.
...
En el siglo XIX, Charles Babbage diseñó la Máquina Analítica, considerada el precursor conceptual del computador moderno. Su colaboradora, Ada Lovelace, fue la primera persona en comprender que una máquina programable podría manipular símbolos además de números, anticipando la informática moderna.

**Concepto clave:** La idea de una máquina capaz de realizar tareas intelectuales precede en varios siglos a la aparición de los computadores electrónicos.
...
En 1950 publicó el artículo *Computing Machinery and Intelligence*, donde planteó una pregunta que sigue siendo objeto de debate:

> **¿Pueden pensar las máquinas?**

Para responderla propuso el **Test de Turing**, una prueba destinada a evaluar si una máquina podía mantener una conversación indistinguible de la de un ser humano.

Aunque hoy se considera una prueba incompleta para medir la inteligencia, el Test de Turing marcó el inicio formal de la discusión científica sobre la Inteligencia Artificial.


:::info[¿Sigue siendo válido el Test de Turing?]

Durante décadas, superar el Test de Turing fue considerado un objetivo central de la IA. Sin embargo, los modelos actuales demuestran que es posible generar respuestas convincentes sin poseer comprensión, conciencia o razonamiento humano. Esto ha llevado a la comunidad científica a considerar que el Test de Turing evalúa principalmente la capacidad de mantener una conversación, pero no constituye una medida suficiente de inteligencia.
:::
...
Durante las décadas de 1950 y 1960 surgieron los primeros programas capaces de resolver problemas específicos:

* Resolución de ecuaciones matemáticas.
* Juegos como damas y ajedrez.
* Demostración automática de teoremas.
* Resolución de problemas lógicos.

Estos sistemas funcionaban mediante reglas explícitas definidas por expertos. Aunque limitados, demostraron que ciertos procesos de razonamiento podían automatizarse.

Sin embargo, pronto se evidenció que este enfoque no era escalable. A medida que aumentaba la complejidad de los problemas, también crecía exponencialmente el número de reglas necesarias para resolverlos.

---

:::info[¿Sabías que...?]
El primer programa capaz de demostrar teoremas matemáticos fue desarrollado en 1956 y consiguió resolver aproximadamente el 85 % de los problemas incluidos en un capítulo completo de *Principia Mathematica*, una de las obras fundamentales de la lógica moderna.
:::
...
*   **IA Responsable y Ética:** La implementación de marcos como la [**ISO 42001**](/docs/iso42001) para asegurar que el desarrollo sea seguro, transparente y respete los derechos humanos.
